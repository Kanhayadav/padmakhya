...
(6, 'Rakesh Kumar', 'rakesh@gmail.com', 'rk01', 'Teacher'),
(13, 'Rahul Aggarwal', 'rahul@gmail.com', 'ra01', 'Student');
...
(3, 'Aman', 22001, 'BCA', 2, 'Paid', 'Present'),
(4, 'Lakshey Gulyani', 22002, 'BBA', 5, 'Pending', 'Absent'),
...
(10, 'Nitika Rawat', 22010, 'BBA', 4, 'Pending', 'Absent'),
(11, 'Chavi Sharma', 22011, 'BBA', 4, 'Pending', 'Present'),
(12, 'Naina Sachdeva', 22005, 'BBA', 5, 'Pending', 'Present'),
...
--
ALTER TABLE `student`
  MODIFY `std_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
